...
public abstract class MechaTechContainers
{
    public static class TileEntityContainer<T extends TileEntity> extends Container
    {
        ...
        public TileEntityContainer(InventoryPlayer playerInventory, T tile, int slotCount)
        {
